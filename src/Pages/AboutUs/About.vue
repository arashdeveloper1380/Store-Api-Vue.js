            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="contact-info">
                        ...
                        <img src="src/assets/images/home/About-Logo.jpg" class="img-responsive">
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="about">
                        ...
                        <p class="about-desc">
                            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده ازلورملورم ایپسوم
            ...
            <div class="row">
                <div class="container">
                    <div class="col-sm-12" style="overflow: hidden; margin-bottom: 40px">
                        <h2 class="title text-center">مـا اینجـا هستیـم ... </h2>
                        <div id="gmap" class="contact-map">
                            <img src="src/assets/images/home/Map.jpg" alt="Map">
                        </div>
                    </div>
                </div>
            </div>
